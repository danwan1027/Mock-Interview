      ...
      <div className="HeyGenStreamingAvatar">
        <header className="App-header">
          ...
          <div className="LabelPair">
            ...
            <input className="InputField2" placeholder='Avatar ID' value={avatarId || "Eric_public_pro2_20230608"}  onChange={(v) => setAvatarId(v.target.value)} />
          </div>
          <div className="LabelPair">
            <label>Voice ID</label>
            <input className="InputField2" placeholder='Voice ID' value={voiceId || "077ab11b14f04ce0b49b5f6e5cc20979"} onChange={(v) => setVoiceId(v.target.value)} />
          </div>
