...
# Route to add a user
@firebase_test.route('/add_user', methods=['POST'])
def add_user():
...
@firebase_test.route('/update_user', methods=['POST'])
def update_user():
    ...
    db.updateUser(user_id, username, password, email)
    return jsonify({"message": "User updated successfully"}), 200

# Route to delete a user
@firebase_test.route('/del_user', methods=['POST'])
def delete_user():
    user_id = request.form['user_id']
    db.delUser(user_id)
...
@firebase_test.route('/get_user_id', methods=['POST'])
def get_user_id():
    email = request.form['email']
    db.getUserID(email)
...
@firebase_test.route('/add_interview', methods=['POST'])
def add_interview():
...
@firebase_test.route('/del_interview', methods=['POST'])
...
@firebase_test.route('/add_emotion_recognition', methods=['POST'])
...
@firebase_test.route('/del_emotion_recognition', methods=['POST'])
...
@firebase_test.route('/add_eye_gaze', methods=['POST'])
def add_eye_gaze():
    duration = int(request.form['duration'])
...
@firebase_test.route('/del_eye_gaze', methods=['POST'])
def delete_eye_gaze():
...
@firebase_test.route('/add_feedback', methods=['POST'])
def add_feedback():
...
@firebase_test.route('/del_feedback', methods=['POST'])
def delete_feedback():
...
@firebase_test.route('/add_question_history', methods=['POST'])
...
@firebase_test.route('/del_question_history', methods=['POST'])
...
@firebase_test.route('/add_voice_transcriptions', methods=['POST'])
...
@firebase_test.route('/del_voice_transcriptions', methods=['POST'])
...
@firebase_test.route('/add_questions', methods=['POST'])
def add_questions():
...
@firebase_test.route('/del_questions', methods=['POST'])
